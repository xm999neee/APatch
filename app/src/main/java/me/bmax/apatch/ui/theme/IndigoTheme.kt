...
// AMOLED 黑色主题颜色 - 靛蓝色版本
private val md_theme_amoled_primary = Color(0xFFBAC3FF)
private val md_theme_amoled_onPrimary = Color(0xFF08218A)
private val md_theme_amoled_primaryContainer = Color(0xFF293CA0)
private val md_theme_amoled_onPrimaryContainer = Color(0xFFDEE0FF)
private val md_theme_amoled_secondary = Color(0xFFC3C5DD)
private val md_theme_amoled_onSecondary = Color(0xFF2D2F42)
private val md_theme_amoled_secondaryContainer = Color(0xFF434659)
private val md_theme_amoled_onSecondaryContainer = Color(0xFFE0E1F9)
private val md_theme_amoled_tertiary = Color(0xFFE6BAD7)
private val md_theme_amoled_onTertiary = Color(0xFF44263D)
private val md_theme_amoled_tertiaryContainer = Color(0xFF5D3C55)
private val md_theme_amoled_onTertiaryContainer = Color(0xFFFFD7F1)
...
private val md_theme_amoled_onBackground = Color(0xFFE4E1E6)
// AMOLED 纯黑色表面
private val md_theme_amoled_surface = Color(0xFF000000)
private val md_theme_amoled_onSurface = Color(0xFFE4E1E6)
// 稍微亮一点的表面变体以保持层次感
private val md_theme_amoled_surfaceVariant = Color(0xFF1A1A1A)
private val md_theme_amoled_onSurfaceVariant = Color(0xFFC7C5D0)
private val md_theme_amoled_outline = Color(0xFF90909A)
private val md_theme_amoled_inverseOnSurface = Color(0xFF000000)
private val md_theme_amoled_inverseSurface = Color(0xFFE4E1E6)
private val md_theme_amoled_inversePrimary = Color(0xFF4355B9)
private val md_theme_amoled_shadow = Color(0xFF000000)
private val md_theme_amoled_surfaceTint = Color(0xFFBAC3FF)
