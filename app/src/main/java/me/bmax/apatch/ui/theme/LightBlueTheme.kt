...
// AMOLED 黑色主题颜色 - 浅蓝色版本
private val md_theme_amoled_primary = Color(0xFF8DCDFF)
private val md_theme_amoled_onPrimary = Color(0xFF00344F)
private val md_theme_amoled_primaryContainer = Color(0xFF004B70)
private val md_theme_amoled_onPrimaryContainer = Color(0xFFCAE6FF)
private val md_theme_amoled_secondary = Color(0xFFB7C9D9)
private val md_theme_amoled_onSecondary = Color(0xFF22323F)
private val md_theme_amoled_secondaryContainer = Color(0xFF384956)
private val md_theme_amoled_onSecondaryContainer = Color(0xFFD3E5F5)
private val md_theme_amoled_tertiary = Color(0xFFCFC0E8)
private val md_theme_amoled_onTertiary = Color(0xFF362B4B)
private val md_theme_amoled_tertiaryContainer = Color(0xFF4D4162)
private val md_theme_amoled_onTertiaryContainer = Color(0xFFEBDDFF)
...
private val md_theme_amoled_onBackground = Color(0xFFE2E2E5)
// AMOLED 纯黑色表面
private val md_theme_amoled_surface = Color(0xFF000000)
private val md_theme_amoled_onSurface = Color(0xFFE2E2E5)
// 稍微亮一点的表面变体以保持层次感
private val md_theme_amoled_surfaceVariant = Color(0xFF1A1A1A)
private val md_theme_amoled_onSurfaceVariant = Color(0xFFC1C7CE)
private val md_theme_amoled_outline = Color(0xFF8B9198)
private val md_theme_amoled_inverseOnSurface = Color(0xFF000000)
private val md_theme_amoled_inverseSurface = Color(0xFFE2E2E5)
private val md_theme_amoled_inversePrimary = Color(0xFF006493)
private val md_theme_amoled_shadow = Color(0xFF000000)
private val md_theme_amoled_surfaceTint = Color(0xFF8DCDFF)
