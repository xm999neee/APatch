...
// AMOLED 黑色主题颜色 - 柠檬色版本
private val md_theme_amoled_primary = Color(0xFFC1D02C)
private val md_theme_amoled_onPrimary = Color(0xFF2F3300)
private val md_theme_amoled_primaryContainer = Color(0xFF444B00)
private val md_theme_amoled_onPrimaryContainer = Color(0xFFDDED49)
private val md_theme_amoled_secondary = Color(0xFFC7C9A6)
private val md_theme_amoled_onSecondary = Color(0xFF30321A)
private val md_theme_amoled_secondaryContainer = Color(0xFF46492E)
private val md_theme_amoled_onSecondaryContainer = Color(0xFFE4E5C1)
private val md_theme_amoled_tertiary = Color(0xFFA2D0C1)
private val md_theme_amoled_onTertiary = Color(0xFF07372D)
private val md_theme_amoled_tertiaryContainer = Color(0xFF234E43)
private val md_theme_amoled_onTertiaryContainer = Color(0xFFBEECDC)
...
private val md_theme_amoled_onBackground = Color(0xFFE5E2DA)
// AMOLED 纯黑色表面
private val md_theme_amoled_surface = Color(0xFF000000)
private val md_theme_amoled_onSurface = Color(0xFFE5E2DA)
// 稍微亮一点的表面变体以保持层次感
private val md_theme_amoled_surfaceVariant = Color(0xFF1A1A1A)
private val md_theme_amoled_onSurfaceVariant = Color(0xFFC8C7B7)
private val md_theme_amoled_outline = Color(0xFF929282)
private val md_theme_amoled_inverseOnSurface = Color(0xFF000000)
private val md_theme_amoled_inverseSurface = Color(0xFFE5E2DA)
private val md_theme_amoled_inversePrimary = Color(0xFF5B6300)
private val md_theme_amoled_shadow = Color(0xFF000000)
private val md_theme_amoled_surfaceTint = Color(0xFFC1D02C)
